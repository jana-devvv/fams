        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Data Proposal <a class="btn btn-success" href="{{ route('proposal.create') }}"> Create <i class="fas fa-plus"></i></a></h3>
            </div>
                ...
                <tbody>
                  @foreach ($proposals as $proposal)
                    <tr>
                      ...
                      <td class="text-center"><span class="badge @if($proposal->status == 'approved') badge-success @elseif($proposal->status == 'rejected') badge-danger @else badge-dark @endif p-2">{{ ucfirst($proposal->status) }}</span></td>
                      <td>
                        <div class="btn-group">
                          ...
                          <div class="dropdown-menu">
                            ...
                            <form id="delete-form" action="{{ route('proposal.destroy', $proposal->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
